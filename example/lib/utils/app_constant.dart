...
const String TWITTER_URL = "https://twitter.com/larisoft";
const String FACEBOOK_URL = "https://www.facebook.com/larisoft";
const String GITHUB_URL = "https://github.com/larisoft";
const String PROJECT_URL = "https://github.com/larisoft";
const String ISSUE_URL = "https://github.com/larisoft";
const String README_URL =
    "https://github.com/larisoft/WhatTodo/blob/master/README.md";
const String EMAIL_URL =
    "mailto:<larypetero@gmail.com>?subject=WhatTodo%20Query&body=Hi";
